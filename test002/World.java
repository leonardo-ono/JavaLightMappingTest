...
public class World {
    ...
    public void render3DPoint(Graphics2D g2d, Color color, Vec3 a) {
        ...
        g2d.setColor(color);
        g2d.drawOval((int) (pax - 3), (int) (pay - 3), 6, 6);
    }
                ...
                for (int l = 0; l < lights.size(); l++) {
                    ...
                    if (intersectionFace == face) {
                        ...
                        if (l == 0) {
                            ...
                            ag += rayIntensity[light.getIntensity(lightPointDistance, energy)].getRed();
                        }
                        else if (l == 2) {
                            //ar += rayIntensity[light.getIntensity(lightPointDistance, energy)].getRed();
                            //ag += rayIntensity[light.getIntensity(lightPointDistance, energy)].getRed();
                            ab += rayIntensity[light.getIntensity(lightPointDistance, energy)].getRed();
                        }
