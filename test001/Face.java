...
public class Face {
    ...
    // 16x16
    public static final int LIGHT_MAP_SIZE = 10;
    ...
    public Face(Vec3 p, ORIENTATION orientation) {
        ...
        switch (orientation) {
            case FRONT -> {
                ...
                wXAxis.set(1, 0, 0);
                wYAxis.set(0, -1, 0);
                uvs[0].set(0.96, 0.96, 0);
                uvs[1].set(0.04, 0.96, 0);
                uvs[2].set(0.04, 0.04, 0);
                uvs[3].set(0.96, 0.04, 0);
            }
            ...
            case BACK -> {
                ...
                wXAxis.set(-1, 0, 0);
                wYAxis.set(0, -1, 0);
                uvs[0].set(0.04, 0.04, 0);
                uvs[1].set(0.96, 0.04, 0);
                uvs[2].set(0.96, 0.96, 0);
                uvs[3].set(0.04, 0.96, 0);
            }
            ...
            case TOP -> {
                ...
                wXAxis.set(1, 0, 0);
                wYAxis.set(0, 0, 1);
                uvs[0].set(0.96, 0.04, 0);
                uvs[1].set(0.96, 0.96, 0);
                uvs[2].set(0.04, 0.96, 0);
                uvs[3].set(0.04, 0.04, 0);
            }
            ...
            case BOTTOM -> {
                ...
                wXAxis.set(1, 0, 0);
                wYAxis.set(0, 0, -1);
                uvs[0].set(0.04, 0.96, 0);
                uvs[1].set(0.04, 0.04, 0);
                uvs[2].set(0.96, 0.04, 0);
                uvs[3].set(0.96, 0.96, 0);
            }
        }
        vertices[0].add(p);
        vertices[1].add(p);
